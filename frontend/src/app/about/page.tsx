          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-6">
                TrueBalance helps you take control of your finances with ease
                and clarity.
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">
                You can securely enter your purchases, recurring bills, and
                sources of income which are all stored in a reliable database.
                We track your financial activity in real time, giving you clear
                insights into your spending, saving, and overall financial
                health.
              </p>

              <p className="text-gray-700 leading-relaxed mb-8">
                With statistics and visual reports, you&apos;ll always know
                where your money is going and how to plan ahead. Whether
                it&apos;s budgeting for the month, managing recurring expenses,
                or analyzing your income trends, our goal is to make personal
                finance simple, transparent, and actionable.
              </p>
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 mb-10">
                ...
                <p className="text-gray-700 mb-4">
                  Lots of people still use physical checkbooks to track their
                  spending. True Balance improves on this through:
                </p>
